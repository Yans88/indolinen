...
<body>
	...
	<div class="form-box" id="">
		<p align="center">
		<strong><?php echo $dt; ?></strong>
	</p>
		<?php if($dt == 'Congratulation') { ?>
			<div class="text-center">
				
				<img src="<?php echo base_url('assets/theme_admin/img/success.png')?>"/>
			</div>
			<div class="text-center"> 
				<strong style="font-size:17px;">Success, Payment received !!!</strong>
			</div>
		<?php } ?>
		<?php if($dt == 'Failed') { ?>
			<div class="text-center">
				
				<img src="<?php echo base_url('assets/theme_admin/img/error.png')?>"/>
			</div>
			<div class="text-center"> 
				<strong style="font-size:17px;">Url invalid, Please contact admin.</strong>
			</div>
		<?php } ?>
	</div>
