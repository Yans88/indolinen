...
<div class="modal fade" role="dialog" id="frm_category">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body" style="padding-bottom:2px;">
                ...
                <div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							<label>Image2</label><span class="label label-danger pull-right category_error"></span>
							<input type="file" class="form-control custom-file-input" name="userfile2" id="userfile2" accept="image/*" />
						 
						</div>
						<div class="form-group">
							<div class="fileupload-new thumbnail" style="width: 200px; height: 150px; margin-bottom:5px;">
								<img id="blah2" style="width: 200px; height: 150px;" src="" alt="">
 ...
 <div class="box-header">
    <a href="#"><button class="btn btn-success add_category"><i class="fa fa-plus"></i> Add Category</button></a>
</div>
<div class="box-body">
<div class='alert alert-info alert-dismissable' id="success-alert">
	...
	<table id="example88" class="table table-bordered table-striped">
		<thead><tr>
			...
			<th style="text-align:center; width:20%">Image2</th>	
			...
			<?php 
				...
				if(!empty($category)){		
					foreach($category as $c){	
						...
						$path2 = !empty($c['img2']) ? base_url('uploads/kategori/'.$c['img2']) : base_url('uploads/no_photo.jpg');
						$info = $this->converter->encode($c['id_kategori']).'Þ'.$c['nama_kategori'].'Þ'.$path.'Þ'.$path2;
						echo '<tr>';
						...
						echo '<td class="first" align="center"><a class="" href="'.$path2.'" title="'.$c['nama_kategori'].'"><img width="200" height="200" src="'.$path2.'"></a></td>';
						$view_sub = site_url('category/subcategory/'.$c['id_kategori']);
						echo '<td align="center" style="vertical-align: middle;">		
			<a href="'.$view_sub.'" title="Sub Category"><button class="btn btn-xs btn-info" style="width:105px; margin-bottom:3px;"><i class="fa fa-list"></i> Sub Category</button></a>
			<br/><a href="#" id="'.$info.'" title="Edit" class="edit_category"><button class="btn btn-xs btn-success"><i class="fa fa-edit"></i> Edit</button></a>
...
$('.add_category').click(function(){
	...
	$('#blah2').attr('src', '<?php echo base_url('uploads/no_photo.jpg');?>');
	$('#frm_category').modal({
		backdrop: 'static',
		keyboard: false
	});
