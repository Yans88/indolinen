          ...
          <div class="modal-dialog" style="width:400px">
            <div class="modal-content">
              ...
              <div class="modal-body">
				<h4 class="text-center">Apakah anda yakin <br/>komplain ini di <b>Approve</b> ? </h4>
...
<div class="modal fade" role="dialog" id="confirm_reject">
          <div class="modal-dialog" style="width:400px">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              ...
              <div class="modal-body">
				<h4 class="text-center">Apakah anda yakin <br/>komplain ini di <b>Reject</b> ? </h4>
				
              </div>
              <div class="modal-footer" style="margin-top:0px;">
                <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>               
                <button type="button" class="btn btn-warning yes_reject">Reject</button>               
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
...
?>	
	<table class="table table-bordered table-reponsive">
		...
		<tr class="header_kolom">
			...
			<th style="vertical-align: middle; text-align:center">Complain - Refund</th>
			...
			<table class="table table-responsive">
				<tbody>
					<tr style="vertical-align:middle; text-align:left">
						...
						<td style="width:1%;">:</td>
						<td><?php echo !empty($transaksi->address_bn) ? $transaksi->address_bn : '-';?></td>	
					...
					<tr style="vertical-align:middle; text-align:left"> 
						...
						<td style="width:1%;">:</td>
						<td><?php echo !empty($transaksi->refund_amount) ?  number_format($transaksi->refund_amount,0,',','.') : '-';?></td>	 
...
<div class="box-footer clearfix">
	...
	<button type="button" class="btn btn-small btn-danger btn_reject"><i class="glyphicon glyphicon-remove"></i> Reject</button>			
	<button type="button" class="btn btn-small btn-info btn_appr"><i class="glyphicon glyphicon-ok"></i> Approve</button>			
	</div>
</div>
<?php } ?>
...
$('.yes_reject').click(function(){	
	var url = '<?php echo site_url('complain/upd_status');?>';
	$.ajax({
		data:{id_transaksi:id_transaksi,status:3},
		type:'POST',
		url : url,
...
$('.yes_appr').click(function(){	
	var url = '<?php echo site_url('complain/upd_status');?>';
	$.ajax({
		data:{id_transaksi:id_transaksi,status:2},
		type:'POST',
		url : url,
		success:function(response){
			if(response > 0){
